...
# with command line options: Pythia_H0_pyupda_8TeV_cfi.py --step=GEN,SIM,DIGI,L1,DIGI2RAW,HLT --conditions=START53_LV6A1::All --fileout=simu_test.root --number=100 --mc --no_exec
